...
public enum ModArmorMaterials implements ArmorMaterial {
    ENDERITE("enderite", 35, new int[] { 4, 10, 8, 4 }, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 5f, 0.5f,
            () -> Ingredient.ofItems(ModItems.ENDERITEINGOT));
    ;
    ...
    public String getName() {
        return AFunnyMod.MOD_ID + ":" + this.name;
    }
